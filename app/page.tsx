      ...
      <div className="relative z-10">
        ...
        <section className="relative overflow-hidden px-4 py-32 pt-40 md:pt-32 md:py-40">
          <div className="absolute inset-0 pointer-events-none">
            ...
            ></div>
            <div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-purple-500/5 to-transparent rounded-full blur-3xl animate-spin"
